...
interface CMODetailsViewProps {
  contractData?: Contract;
}

export const CMODetailsView = ({ contractData }: CMODetailsViewProps) => {

  const data = Object.values(contractData?.cmoDetails || {}).sort((a,b) => a.sno - b.sno)
  ...
  return (
    <Card title="CMO Details" style={{ height: "100%" }}>
      <FormTable dataSource={data} columns={columns} />
    </Card>
  );
};
