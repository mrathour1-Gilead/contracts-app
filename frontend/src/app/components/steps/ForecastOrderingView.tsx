...
interface ForecastOrderingViewProps {
  contractData?: any;
}

export function ForecastOrderingView({ contractData }: ForecastOrderingViewProps) {
  ...
  return (
    <Card title="Forecast and Ordering" style={{ height: "100%" }}>
